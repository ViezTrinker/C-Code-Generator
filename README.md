...
Latest notes: [`RELEASE_NOTES_V_1.3.0.R.md`](RELEASE_NOTES_V_1.3.0.R.md)
...
Short graphs that teach one IR feature. Regenerate with `python scripts\generate_feature_examples.py`.
...
**Dungeon Log** covers nearly every block family (structs, multi-arg Call, Address Of, Malloc/Free, files, time). Regenerated by [`scripts/generate_dungeon_log.py`](scripts/generate_dungeon_log.py). Snapshot: [`examples/build_out/dungeon_log.c`](examples/build_out/dungeon_log.c).
...
Releases are tagged as `V_x.y.z.R` (see [release notes](RELEASE_NOTES_V_1.3.0.R.md)). If you use this in a classroom or fork it, a root `LICENSE` file is recommended — open an issue if you’d like one added.
